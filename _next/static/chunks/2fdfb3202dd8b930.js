(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript :
    ...
    88917, e => {
        ...
        e.s(["default", 0, (e, l, d = c, p = []) => {
            ...
            (0, a.default)(e => {
                ...
                k.current = document.body
            }, []), (0, s.default)(k, () => {
                h.current = W.current && -1 !== d.mediaQueries.indexOf(W.current), h.current &&
                    (w.current = e.current ? (0, n.offsetTop)(e.current) : 0), x.current = !0
            }, [W.current]), (0, o.default)(({
                animatedScroll: e
            }) => {
                m.current = e || 0
            });
            let S = (0, t.useCallback)(() => {
                if (h.current && e.current && f.current.documentHeight && v.current) {
                    let e = x.current ? 1 : d.ease || 1,
                        ...
                        r = N * v.current - T * f.current.documentHeight;
    ...
    23687, e => {
        ...
        let u = (0, s.forwardRef)(({
            ...
            return (0, i.default)(j, (e, {
                ...
                if (T.current = a, !(v.includes(q?.current) && !1 === O)) return !1;
                ...
                let w = s - t,
                    x = l.documentHeight;
                W.current = e * (void 0 !== d ? d : 0) * (r ? Math.abs(o) : 1), k.current = e *
                    (void 0 !== p ? p : 0) * (r ? Math.abs(c) : 1), (f || h) && (N.current = -
                        f * w / x + h);
                let b = {
                        x: (0, n.precision)(W.current),
                        y: (0, n.precision)(k.current),
                        rotate: f
                    },
                    y = w + k.current,
    ...
    78834, e => {
        ...
        var t = e.i(74010),
            ...
            s = e.i(37619),
            a = e.i(39906);
        e.s(["GsapScrollTrigger", 0, () => ((0, t.default)(() => {
                ...
                let et = e => {
                        ...
                        if (t && Q.current) {
                            ...
                            Q.current.scale(s, s), (j || ["png"].includes(y)) && Q.current.clearRect(0, 0,
                                a, l), Q.current.imageSmoothingEnabled = k, Q.current.drawImage(t, 0, 0,
