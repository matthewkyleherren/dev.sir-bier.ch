        ...
        o(),
            function() {
                let n = e => e,
                    ...
                    r = a.currentScript;
                if (t()) return;
                let i = (null == r ? void 0 : r.dataset.endpoint) || (null != r && r.src.includes("/va/") ?
                        "/va" : "/_vercel/insights"),
                ...
                async function d(e) {
                    ...
                    let n = new URL(r.src),
                        i = n.pathname.split("/"),
                        o = i.pop();
                    return o && i.push("flags", o), n.pathname = i.join("/"), import(n.href).then(n => n
                        .gather(t, e))
                }
                async function c({
                    type: t,
                ...
                let y = e(),
                    g = () => {
                        ...
                        window.va = function(e, t) {
                            "beforeSend" === e ? n = t : "event" === e ? t && p(t.name, t.data, t.options) :
                                "pageview" === e && t && (t.route && (l = t.route), t.path && (s = t.path),
                                    f({
                                        withReferrer: u
